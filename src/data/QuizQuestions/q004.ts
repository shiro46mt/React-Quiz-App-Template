...
export const Q004: Topic = {
  ...
  questions: [
    {
      question: 'Guests at Hayworth Hotel can ------ access most of the city’s tourist attractions.',
      choices: ['easy', 'ease', 'easier', 'easily'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['submit', 'submitted', 'had submitted', 'were submitted'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['prediction', 'fine', 'warranty', 'committee'],
      type: 'MCQs',
      correctAnswers: ['fine'],
      score: 1,
    },
    {
      ...
      choices: ['estimating', 'estimator', 'estimated', 'estimate'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['contains', 'hires', 'holds', 'remains'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['introductory', 'introduced', 'introducing', 'introduce'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['Whoever', 'Anything', 'Who', 'Anyone'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['analyst', 'analyze', 'analysis', 'analytic'],
      type: 'MCQs',
