...
export const Q017: Topic = {
  ...
  questions: [
    {
      question: 'Ryofu Transport focuses ------ on meeting deadlines while keeping transportation costs low.',
      choices: ['heavier', 'heavily', 'heavy', 'heaviness'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['committee', 'urgency', 'storage', 'procedure'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['easy', 'ease', 'easily', 'easier'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['Because', 'Only', 'Due to', 'Until'],
      type: 'MCQs',
      correctAnswers: ['Only'],
      score: 1,
    },
    ...
    },
    {
      ...
      choices: ['favorably', 'favorable', 'favor', 'favoring'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['acquire', 'generate', 'merge', 'compile'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['revise', 'revising', 'revised', 'revises'],
      type: 'MCQs',
