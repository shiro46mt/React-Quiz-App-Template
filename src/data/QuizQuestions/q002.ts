...
export const Q002: Topic = {
  ...
  questions: [
    {
      question: 'Professional and amateur photographers ------ can participate in the annual photography contest, which takes place in October.',
      choices: ['alike', 'even', 'quite', 'enough'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['occasions', 'occasion', 'occasionally', 'occasional'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['Afterward', 'Prior to', 'Once', 'During'],
      type: 'MCQs',
      correctAnswers: ['Once'],
      score: 1,
    ...
    },
    {
      ...
      choices: ['Despite', 'Although', 'Nevertheless', 'Whenever'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['both', 'few', 'most', 'a lot of'],
      type: 'MCQs',
      correctAnswers: ['few'],
      score: 1,
