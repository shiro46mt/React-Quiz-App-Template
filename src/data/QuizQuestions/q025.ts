...
export const Q025: Topic = {
  ...
  questions: [
    {
      question: 'After obtaining estimates from several design firms, it proved too ------ to restore that historic building.',
      choices: ['cost', 'costly', 'costs', 'costing'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['closely', 'shortly', 'anonymously', 'relatively'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['itemized', 'distributed', 'reassured', 'launched'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['significantly', 'significance', 'most significant', 'significant'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['host', 'expedite', 'found', 'remodel'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['regulation', 'architect', 'exhibition', 'questionnaire'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['respectively', 'beforehand', 'instead', 'consistently'],
      type: 'MCQs',
