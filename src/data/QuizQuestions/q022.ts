...
export const Q022: Topic = {
  ...
  questions: [
    {
      question: 'If you have any questions about the internal network, please ask ------ Ms. Kawasaki or Mr. Miyamoto in the IT department.',
      choices: ['both', 'either', 'not only', 'neither'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['commutes', 'commuting', 'commuters', 'to commute'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['whoever', 'what', 'who', 'whenever'],
      type: 'MCQs',
      correctAnswers: ['who'],
      score: 1,
    },
    {
      ...
      choices: ['planner', 'has been planed', 'planed', 'plans'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['most of', 'all', 'each', 'several'],
      type: 'MCQs',
      correctAnswers: ['each'],
      score: 1,
    },
    {
      ...
      choices: ['outdated', 'preliminary', 'picturesque', 'congested'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['even', 'evened', 'evenly', 'evenness'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['them', 'they', 'themselves', 'their'],
      type: 'MCQs',
