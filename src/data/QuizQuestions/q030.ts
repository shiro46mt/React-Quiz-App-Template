...
export const Q030: Topic = {
  ...
  questions: [
    {
      question: 'Product brochures and samples will be ------ to visitors at the upcoming new product presentation.',
      choices: ['imported', 'received', 'obtained', 'distributed'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['professional', 'profession', 'professionalism', 'professionally'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['published', 'corresponded', 'resided', 'intended'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['assigned', 'assign', 'assignment', 'assigns'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['expanded', 'published', 'relocated', 'extended'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['extend', 'pursue', 'undergo', 'expire'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['spacious', 'rigorous', 'acclaimed', 'cautious'],
      type: 'MCQs',
