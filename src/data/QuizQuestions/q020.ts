...
export const Q020: Topic = {
  ...
  questions: [
    {
      question: 'The company’s construction of a factory in Thailand has ------ in the creation of more than 500 new jobs.',
      choices: ['generated', 'resulted', 'occupied', 'realized'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['durable', 'generous', 'dependent', 'extensive'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['similarly', 'nearly', 'anonymously', 'sufficiently'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['tutorials', 'exports', 'permits', 'measurements'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['relation', 'related', 'relate', 'relates'],
      type: 'MCQs',
