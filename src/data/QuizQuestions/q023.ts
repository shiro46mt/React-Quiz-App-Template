...
export const Q023: Topic = {
  ...
  questions: [
    {
      question: 'There are three employees ------ for promotion to accounting manager, and they are scheduled to be interviewed by the accounting director next week.',
      choices: ['frequent', 'eligible', 'brief', 'dominant'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['many', 'other', 'plenty of', 'few'],
      type: 'MCQs',
      correctAnswers: ['few'],
      score: 1,
    ...
    },
    {
      ...
      choices: ['summarily', 'summarized', 'summary', 'summarize'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['efficiencies', 'efficient', 'efficiently', 'efficiency'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['founded', 'accompanied', 'addressed', 'praised'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['slighter', 'slight', 'slightest', 'slightly'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['raise', 'discard', 'proofread', 'reimburse'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['to make', 'make', 'making', 'made'],
      type: 'MCQs',
      correctAnswers: ['make'],
      score: 1,
