...
export const Q010: Topic = {
  ...
  questions: [
    {
      question: 'Altona Grocery Store has a good reputation because it carries ------ grown vegetables.',
      choices: ['locality', 'localize', 'local', 'locally'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['considerable', 'loyal', 'resistant', 'capable'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['comprehensive', 'comprehend', 'comprehension', 'comprehensively'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['most of', 'most', 'all', 'every'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['assemble', 'assembled', 'assembles', 'assembly'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['renovating', 'renovation', 'renovated', 'renovate'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['large', 'largest', 'more largely', 'larger'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['will be attend', 'attends', 'is attending', 'attended'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['consistency', 'consistently', 'consistent', 'consistence'],
      type: 'MCQs',
