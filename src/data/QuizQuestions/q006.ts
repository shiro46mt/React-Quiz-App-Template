...
export const Q006: Topic = {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ['idealist', 'ideal', 'idealism', 'ideally'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['transparent', 'complimentary', 'fierce', 'protective'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['preserves', 'reduces', 'withstands', 'deserves'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['width', 'wide', 'widen', 'widely'],
      type: 'MCQs',
      correctAnswers: ['wide'],
      score: 1,
    },
    {
      ...
      choices: ['Request', 'Compliance', 'Donation', 'Admission'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['reasonable', 'reasonably', 'reason', 'reasoning'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['promoted', 'assured', 'affected', 'specialized'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['reliably', 'potentially', 'relatively', 'promptly'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['before', 'from', 'within', 'until'],
      type: 'MCQs',
