...
export const Q024: Topic = {
  ...
  questions: [
    {
      question: 'Hillside Amusement Park is one of the most popular tourist ------ in the area and many people visit there.',
      choices: ['attracts', 'attractions', 'attractive', 'attractively'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['promote', 'establish', 'prescribe', 'subscribe'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['variety', 'varieties', 'vary', 'various'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['accommodate', 'suspend', 'examine', 'decline'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['experts', 'expert', 'expertise', 'expertly'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['lowest', 'lowing', 'low', 'lower'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['commend', 'implement', 'waive', 'postpone'],
      type: 'MCQs',
