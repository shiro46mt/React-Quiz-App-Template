...
export const Q019: Topic = {
  ...
  questions: [
    {
      question: 'Mr. Shu and Ms. Sanon are colleagues at Arson Group ------ graduated from the same university in Australia.',
      choices: ['which', 'where', 'what', 'who'],
      type: 'MCQs',
      correctAnswers: ['who'],
      score: 1,
    },
    {
      ...
      choices: ['multiplying', 'multiple', 'multiply', 'multiplied'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['conflict', 'garment', 'allowance', 'chance'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['capable', 'confident', 'accurate', 'ideal'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['strength', 'strengthen', 'strongly', 'strong'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['correct', 'valid', 'favorable', 'original'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['responsibility', 'responsible', 'responsibly', 'response'],
      type: 'MCQs',
