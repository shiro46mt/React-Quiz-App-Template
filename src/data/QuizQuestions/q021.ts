...
export const Q021: Topic = {
  ...
  questions: [
    {
      question: 'Those who do not return their rental cars by the scheduled due date will be charged an ------ fee.',
      choices: ['addition', 'additionally', 'add', 'additional'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['now that', 'even though', 'so that', 'after'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['final', 'finally', 'finalize', 'finalizes'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['slightly', 'commonly', 'overwhelmingly', 'temporarily'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['height', 'high', 'highly', 'heighten'],
      type: 'MCQs',
      correctAnswers: ['high'],
      score: 1,
    },
    ...
    },
    {
      ...
      choices: ['exclude', 'exclusive', 'exclusively', 'exclusion'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['aspiring', 'exhausted', 'exceptional', 'applicable'],
      type: 'MCQs',
