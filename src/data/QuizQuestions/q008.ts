...
export const Q008: Topic = {
  ...
  questions: [
    {
      question: '------ you find any mistakes in the brochure, please contact the museum office as soon as possible.',
      choices: ['Should', 'Because', 'So that', 'In case of'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['referred', 'refer', 'referring', 'reference'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['Anyone', 'Whoever', 'Each', 'Those'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['difficultly', 'difficulty', 'difficulties', 'difficult'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['dedication', 'dedicated', 'dedicating', 'dedicatedly'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['every', 'all', 'another', 'much'],
      type: 'MCQs',
      correctAnswers: ['all'],
      score: 1,
    ...
    },
    {
      ...
      choices: ['although', 'nevertheless', 'unless', 'despite'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['devising', 'devised', 'devise', 'devises'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['persuaded', 'detected', 'reminded', 'replaced'],
      type: 'MCQs',
