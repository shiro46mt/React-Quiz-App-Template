...
export const Q005: Topic = {
  ...
  questions: [
    {
      question: 'To go to work, Ms. Khan needed to rent a car while ------ was being repaired.',
    ...
    },
    {
      ...
      choices: ['oversee', 'present', 'approve', 'expect'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['responsive', 'respond', 'responsively', 'response'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['among', 'over', 'before', 'onto'],
      type: 'MCQs',
      correctAnswers: ['over'],
      score: 1,
    },
    {
      ...
      choices: ['frequent', 'eligible', 'accurate', 'responsible'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['regarding', 'unlike', 'without', 'following'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['Application', 'Applicant', 'Apply', 'Applicants'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['asked', 'coordinated', 'covered', 'directed'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['availabilities', 'available', 'availability', 'availably'],
      type: 'MCQs',
