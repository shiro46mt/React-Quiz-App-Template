...
export const Q014: Topic = {
  ...
  questions: [
    {
      question: 'Reza West Consulting has been actively recruiting employees with ------ backgrounds.',
      choices: ['diversely', 'diversify', 'diversity', 'diverse'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['moderate', 'confidential', 'prosperous', 'confident'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['instructions', 'destinations', 'connections', 'appointments'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['reliable', 'relies', 'reliably', 'reliability'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['overseeing', 'overlooking', 'transferring', 'undergoing'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['acting', 'active', 'actively', 'action'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['renew', 'renewable', 'renewal', 'renewably'],
      type: 'MCQs',
