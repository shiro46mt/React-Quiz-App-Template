...
export const Q015: Topic = {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ['decline', 'resume', 'preserve', 'misplace'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['helpfulness', 'helps', 'helpful', 'helpfully'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['analyst', 'analysis', 'analyzed', 'analyze'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['another', 'many', 'each of', 'much'],
      type: 'MCQs',
      correctAnswers: ['many'],
      score: 1,
    ...
    },
    {
      ...
      choices: ['subscription', 'participation', 'comparison', 'prescription'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['more proper', 'properly', 'proper', 'properness'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['previously', 'shortly', 'proudly', 'nearly'],
      type: 'MCQs',
