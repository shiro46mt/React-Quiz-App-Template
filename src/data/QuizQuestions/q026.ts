...
export const Q026: Topic = {
  ...
  questions: [
    {
      question: 'Dr. Tsai has been invited as a keynote ------ at the upcoming Mechanical Engineering Conference.',
      choices: ['spoken', 'speakers', 'speaker', 'speaking'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['order', 'service', 'shape', 'stock'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['keenly', 'unanimously', 'relatively', 'considerably'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['vaguely', 'accordingly', 'nearly', 'strongly'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['multiple', 'evident', 'accurate', 'promising'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['resisted', 'resistant', 'resistance', 'resist'],
      type: 'MCQs',
