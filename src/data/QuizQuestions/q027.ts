...
export const Q027: Topic = {
  ...
  questions: [
    {
      question: 'The application deadline for the craft class is next Monday, so those interested should submit their paperwork as ------ as possible.',
      choices: ['quick', 'quicken', 'quickly', 'quickness'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['Despite', 'Although', 'Now that', 'In order that'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['duration', 'token', 'request', 'allowance'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['necessitate', 'necessary', 'necessity', 'necessarily'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['long', 'length', 'longest', 'longer'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['tailoring', 'tailored', 'tailors', 'tailor'],
      type: 'MCQs',
