...
export const Q003: Topic = {
  ...
  questions: [
    {
      question: 'Streamlining the textile production process has resulted in an ------ 20 percent increase in productivity.',
      choices: ['apparently', 'approximately', 'affordably', 'efficiently'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['his own', 'him', 'he', 'himself'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['specialize', 'specialist', 'specially', 'special'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['complimentary', 'reluctant', 'prominent', 'renewable'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['tour', 'toured', 'will tour', 'touring'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['periodical', 'periodically', 'period', 'periodic'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['short', 'person', 'progress', 'advance'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['reliability', 'reliable', 'rely', 'reliably'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['led', 'resulted', 'included', 'caused'],
      type: 'MCQs',
