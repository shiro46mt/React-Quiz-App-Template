...
export const Q031: Topic = {
  ...
  questions: [
    {
      question: 'Sales representatives at East Greenville Corporation are recommended to ------ utilize their customer database to increase sales.',
      choices: ['actively', 'activity', 'activate', 'active'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['during', 'within', 'consequently', 'when'],
      type: 'MCQs',
      correctAnswers: ['when'],
      score: 1,
    },
    {
      ...
      choices: ['commonly', 'favorably', 'hardly', 'securely'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['foundation', 'founding', 'found', 'founder'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['priorities', 'responsibilities', 'negotiations', 'facilities'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['not only', 'neither', 'either', 'both'],
      type: 'MCQs',
      correctAnswers: ['both'],
      score: 1,
    },
    {
      ...
      choices: ['grant', 'mayor', 'profession', 'demonstration'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['surround', 'surrounds', 'surrounded', 'surrounding'],
      type: 'MCQs',
