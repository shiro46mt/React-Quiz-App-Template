...
export const Q016: Topic = {
  ...
  questions: [
    {
      question: '------ the necessary parts arrive today, the production of Model 501 will have to be postponed.',
      choices: ['Whenever', 'Without', 'Unless', 'In case'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['historic', 'historically', 'history', 'historian'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['but', 'because', 'although', 'whether'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['heavily', 'steadily', 'immediately', 'commonly'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['flyer', 'prescription', 'nomination', 'token'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['enhance', 'attach', 'prescribe', 'expire'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['protects', 'protective', 'protect', 'protectively'],
      type: 'MCQs',
