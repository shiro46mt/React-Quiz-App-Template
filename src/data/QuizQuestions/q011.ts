...
export const Q011: Topic = {
  ...
  questions: [
    {
      question: 'Mr. Schaeffer managed to finish his new novel even though ------ had only a few days until the deadline.',
      choices: ['his', 'him', 'himself', 'he'],
      type: 'MCQs',
      correctAnswers: ['he'],
      score: 1,
    ...
    },
    {
      ...
      choices: ['those', 'these', 'them', 'which'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['proof', 'preference', 'profile', 'revenue'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['hardly', 'prominently', 'approximately', 'closely'],
      type: 'MCQs',
    ...
    },
    {
      ...
      choices: ['Consequently', 'Once', 'Beforehand', 'Among'],
      type: 'MCQs',
      correctAnswers: ['Once'],
      score: 1,
